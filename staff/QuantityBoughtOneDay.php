<?php
    ...
    //select book
    //(i.4). Xem tổng số sách tính theo mỗi ISBN được mua trong một ngày
    $date_bought = '2021-11-06';
    $sql = "SELECT DISTINCT(bought.isbn),SUM(bought.num),book.name,book.thumbnail,invoice.date_pay
...
?>
<h3 style="margin:70px 350px 0">Xem tổng số sách tính theo mỗi ISBN được mua trong một ngày 2021-12-01</h3>
<table class="table">
  <thead>
    <tr>
      <th scope="col">STT</th>
